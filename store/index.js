...
export const mutations = {
	saveProperty(state, property) {
		console.log('mutation saveProperty: ', property)
		let saved = state.properties.saved;
		saved.push(property);
	},
	...
	movePropertytoResults(state, property) {
		console.log('mutation movePropertytoResults: ', property)
		let results = state.properties.results;
...
export const actions = {
	moveToPropertyToSaved({commit}, property) {
		commit('saveProperty', property);
		commit('removePropertyFromResults', property);
	},
	moveToPropertyToResults({commit}, property) {
		commit('movePropertytoResults', property);
		commit('removePropertyFromSaved', property);
	}
};

export const getters =  {
	getResults: (state) => {
		return state.properties.results;
	},
